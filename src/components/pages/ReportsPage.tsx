...
import { db, MONTHS, ACADEMIC_YEARS, getPerformanceLevel, getDeptName, SCHOOL_NAME, DESIGNER_CREDIT, getUserDeptIds, getUserDeptLabel } from '@/lib/data';
...
export default function ReportsPage({ currentUser }: Props) {
  ...
  }, [evaluations, selYear, selMonth, selDept, reportType, teachers, departments]);
  ...
  return (
    <div style={{ padding:'1.5rem', direction:'rtl' }}>
      <h2 style={{ fontSize:'1.1rem', fontWeight:800, color:'#0F2044', marginBottom:'1.25rem' }}>📋 التقارير</h2>
      ...
      <div style={{ display:'flex', gap:'0.75rem', flexWrap:'wrap', marginBottom:'1.25rem' }}>
        ...
        <button onClick={printReport} className="btn btn-ghost">🖨️ طباعة</button>
      </div>
      ...
      <div style={cardStyle} id="report-header">
        <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', flexWrap:'wrap', gap:'1rem' }}>
          ...
          <div style={{ textAlign:'left' }}>
            <img src="/school-logo.png" alt={SCHOOL_NAME} style={{ height:'50px', objectFit:'contain' }} />
          </div>
        </div>
      </div>
