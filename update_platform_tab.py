    ...
    <div style={{ direction: 'rtl' }}>
      ...
      >
        ...
        <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap', alignItems: 'center' }}>
          ...
          >
            <span>🖨️</span> طباعة / تصدير التقرير الشامل (PDF)
          </button>
        ...
        <div>
          ...
          <div style={{ ...cardStyle, borderRight: '4px solid #EF4444', marginBottom: '1.25rem' }}>
            ...
            <div style={{ overflowX: 'auto' }}>
              <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.78rem' }}>
                <thead>
                  <tr style={{ background: '#FEF2F2', borderBottom: '2px solid #FECACA', color: '#991B1B' }}>
          ...
          <div style={{ ...cardStyle, borderRight: '4px solid #00B4D8', marginBottom: '1.25rem' }}>
            ...
            <div style={{ overflowX: 'auto' }}>
              <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.76rem' }}>
                <thead>
                  <tr style={{ background: '#F0F9FF', borderBottom: '2px solid #BAE6FD', color: '#0369A1' }}>
                    <th style={{ padding: '0.4rem 0.5rem', textAlign: 'right' }}>اسم المعلم</th>
                    <th style={{ padding: '0.4rem 0.5rem', textAlign: 'right' }}>القسم</th>
...
with open('/Users/ahmadtubaishat/.gemini/antigravity/scratch/teacher-tracking/src/components/pages/PlatformReportTab.tsx', 'w', encoding='utf-8') as f:
    f.write(content)

print('PlatformReportTab.tsx rewritten successfully!')
